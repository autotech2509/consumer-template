...
from src.database.mongo.index_create import create_mongo_indexes
from src.database.mongo.base_model_meta import BaseModelMeta
...
class BaseMongoDB(object, metaclass=BaseModelMeta):
    ...
    def create_indexes(cls, indexes: typing.Sequence[IndexModel] = None):
        ...
        if indexes is None and hasattr(cls, "indexes"):
            indexes = cls.indexes
